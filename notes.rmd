...
## 7 Beta binomial regression
  ...
  + **problem**: so far we dismissed the intuition that a player with higher AB gets played more because he is better.
  + This could be incorporated into the priors so that now every player would have a personal prior
  +
